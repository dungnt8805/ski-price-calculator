...
<div class="wrap">
    ...
    <div id="col-container" class="wp-clearfix">
        <div id="col-left">
            <div class="col-wrap">
                <div class="form-wrap">
                    <h2><?= $edit_difficulty ? 'Edit Difficulty' : 'Add New Difficulty' ?></h2>
                    <form method="post">
                        ...
                        <div class="form-field form-required">
                            <label for="spcu_difficulty_name">Name</label>
                            <input type="text" id="spcu_difficulty_name" name="name" required value="<?= esc_attr($edit_difficulty['name'] ?? '') ?>" placeholder="Beginner">
                        </div>
                        ...
                        <div class="form-field">
                            <label for="spcu_difficulty_description">Description</label>
                            <textarea id="spcu_difficulty_description" name="description" rows="5" placeholder="Optional description for this difficulty."><?= esc_textarea($edit_difficulty['description'] ?? '') ?></textarea>
                        </div>

                        <div class="form-field">
                            <label for="spcu_difficulty_color">Color</label>
                            <input type="color" id="spcu_difficulty_color" name="color" value="<?= esc_attr($edit_difficulty['color'] ?? '#111111') ?>">
                        </div>

                        <p class="submit">
                            <button type="submit" name="<?= $edit_difficulty ? 'edit_difficulty' : 'add_difficulty' ?>" class="button button-primary">
                                <?= $edit_difficulty ? 'Update Difficulty' : 'Add New Difficulty' ?>
                            </button>
                            <?php if($edit_difficulty): ?>
